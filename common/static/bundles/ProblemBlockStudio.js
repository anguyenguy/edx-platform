(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([48],{
            ...
            MarkdownEditingDescriptor.markdownToXml = function (markdown) {
                ...
                toXml = function toXml(partialMarkdown) {
                    var xml = partialMarkdown,
                        ...
                        extractHint,
                        demandhints;
                    var responseTypes = ['optionresponse', 'multiplechoiceresponse', 'stringresponse', 'numericalresponse', 'choiceresponse'];
                    ...
                    xml = xml.replace(/(^s?\=\s*(.*?$)(\n*(or|not)\=\s*(.*?$))*)+/gm, function (match, p) {
                        ...
                        var answersList = p.split('\n'),
                            ...
                            var firstAnswer, answerData, numericalResponseString, additionalAnswerString, textHint, hintLine, additionalTextHint, additionalHintLine, orMatch, hasTolerance;
...
module.exports = __webpack_require__("./common/static/xmodule/descriptors/js/001-f497395d577496a5c0e623cd3e9678a9.js");
