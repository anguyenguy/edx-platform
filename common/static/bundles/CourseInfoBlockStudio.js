(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([38,37,39,40],{
      ...
      function HTMLEditingDescriptor(element) {
        ...
        if (this.editor_choice === 'visual') {
          ...
          if (typeof process != "undefined" && undefined) {
            var tinyMceAdditionalPlugins = undefined.TINYMCE_ADDITIONAL_PLUGINS;
...
//# sourceMappingURL=CourseInfoBlockStudio.js.map