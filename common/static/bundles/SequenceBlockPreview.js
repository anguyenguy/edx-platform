        ...
        this.Sequence = function () {
            ...
            Sequence.prototype.render = function (newPosition) {
                ...
                if (this.position !== newPosition) {
                    ...
                    this.content_container.html(currentTab.text()) // xss-lint: disable=javascript-jquery-html
                    .attr('aria-labelledby', currentTab.attr('aria-labelledby')).data('bookmarked', bookmarked);
            ...
            Sequence.prototype.mark_visited = function (position) {
                ...
                element.attr({ tabindex: '-1', 'aria-selected': 'false', 'aria-expanded': 'false' }).removeClass('inactive').removeClass('active').removeClass('focused').addClass('visited');
            };
            ...
            Sequence.prototype.mark_active = function (position) {
                // Don't overwrite class attribute to avoid changing Progress class
                var element = this.link_for(position);
                element.attr({ tabindex: '0', 'aria-selected': 'true', 'aria-expanded': 'true' }).removeClass('inactive').removeClass('visited').removeClass('focused').addClass('active');
...
module.exports = __webpack_require__("./common/static/xmodule/modules/js/001-46e7fadf5c6824193a9daade0a98abf6.js");


/***/ })

},[17])));
//# sourceMappingURL=SequenceBlockPreview.js.map