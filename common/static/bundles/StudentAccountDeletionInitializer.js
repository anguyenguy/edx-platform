(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([15,19,23],{
...
var StudentAccountDeletion = function (_React$Component) {
  ...
  _createClass(StudentAccountDeletion, [{
    ...
    value: function render() {
      ...
      var activationError = __WEBPACK_IMPORTED_MODULE_3_edx_ui_toolkit_js_utils_string_utils___default.a.interpolate(gettext('Before proceeding, please {htmlStart}{emailMsg}{htmlEnd}.'), {
...
StudentAccountDeletion.propTypes = {
  ...
  mktgEmailOptIn: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool.isRequired
};
